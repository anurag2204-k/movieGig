        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="flex space-x-10 justify-center items-center mb-14">
                    <a href="https://x.com/anurag_k04" target="_blank" className="block  text-gray-900 transition-all duration-500 hover:text-indigo-600 ">
                    ...
                    <a href="https://www.instagram.com/anuragk2204/" target="_blank" className="block  text-gray-900 transition-all duration-500 hover:text-indigo-600 ">
                    ...
                    <a href="#https://www.facebook.com/anurag.khobragade.31" target="_blank" className="block  text-gray-900 transition-all duration-500 hover:text-indigo-600 ">
